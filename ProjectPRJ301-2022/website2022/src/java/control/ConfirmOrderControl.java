 ...
 * @author ADMIN
 */
@WebServlet(name = "ConfirmOrderControl", urlPatterns = {"/confirm"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (currentAccount != null) {
            ...
            if (customerOrder != null) {
                boolean confirmOrder = OrdersDAO.confirmOrder(Integer.parseInt(orderID), currentAccount.getUser(), Float.parseFloat(billTotal));
            }
