 ...
 * @author Son
 */
@WebServlet(name = "OrdersDetailControl", urlPatterns = {"/ordersdetail"})
public class OrdersDetailControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<OrdersDetail> listOrdersDetail = dao.getAllOrdersDetail();
        DAO daoo = new DAO();
        List<Product> listProduct = daoo.getAllProduct();
        
        
        
        request.setAttribute("listO", listOrdersDetail);
