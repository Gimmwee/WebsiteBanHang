...
<html lang="en">
    ...
    <script >
            ...
            window.location = "updateAddToCart?id=${i.id}&quantity=0&orderID=${listOrderDetail[0].orderID}" + id;
            }
            }
        </script>
    ...
    <body>
                        ...
                        <tr>
                            <c:forEach items="${listProduct}" var="i">
                                <c:if test="${i.id == o.productID}">
                                    ...
                                    <td ><a href="updateAddToCart?id=${i.id}&quantity=0&orderID=${listOrderDetail[0].orderID}" onclick="funtion('${i.id}')">
        ...
        <div class="bill" >                           
            <div class="billl" >
                <a href="confirm?orderID=${listOrderDetail[0].orderID}&&billTotal=<c:out value="${PriceTotal}"/>" class="btn btn-primary">Mua hàng</a>
            </div>
        </div>
